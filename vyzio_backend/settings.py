...
# After building React (npm run build), the main index.html lives in "frontend/build"
# This allows Django to serve React’s index.html as the main page.
TEMPLATES[0]["DIRS"] = [FRONTEND_DIR / "build"]

# Folder where Django will collect all static files during deployment
# (admin CSS/JS + React build files). Used when running "python manage.py collectstatic"
STATIC_ROOT = BASE_DIR / "static"

# Tell Django where React’s static assets are (CSS, JS, images generated by build)
# This makes sure React’s JS and CSS load correctly when served by Django.
STATICFILES_DIRS = [
    FRONTEND_DIR / "build" / "static",
    FRONTEND_DIR / "build",   # This line makes /favicon.ico & /manifest.json available
]
