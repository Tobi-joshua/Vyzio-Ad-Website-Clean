...
export default function BuyerAdsCategories() {
  const {firstName, email, userAvatar, userId,notificationCount } = useContext(BuyerDashboardContext);
  ...
  return (
     <Box sx={{ minHeight: "100vh", background: pageBg(), pb: 8 }}>
            <BuyerAppBar userAvatar={userAvatar} firstName={firstName} notificationCount={notificationCount} />
            <Toolbar />
  ...
  return (
    ...
    >
      <Card
        ...
        onClick={() => navigate(`/buyers/categories/${id}/${encodeURIComponent(name)}/ads`)}
      >
        <Avatar
          sx={{
        ...
        <CardActions sx={{ px: 3, pb: 2 }}>
          <Button
            ...
            onClick={(e) => {
              e.stopPropagation();
              navigate(`/buyers/categories/${id}/${encodeURIComponent(name)}/ads`);
            }}
          >
            View Ads
          </Button>
