...
export default function SellerAccountSettings() {
  const {userId, token, userAvatar} = useContext(SellerDashboardContext);
  ...
  useEffect(() => {
    ...
    setLoading(true);
    fetch(`${API_BASE_URL}/api/seller/account-settings/`, {
      headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch(`${API_BASE_URL}/api/seller/account-settings/`, {
        method: "PUT",
        headers: {
          Authorization: `Bearer ${token}`,
        },
