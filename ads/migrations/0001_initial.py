# Generated by Django 5.2.5 on 2025-08-07 14:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(db_index=True, default='USA', max_length=50, null=True)),
                ('date_of_birth', models.DateField(blank=True, db_index=True, help_text='Format: YYYY-MM-DD', null=True)),
                ('avatar', models.ImageField(blank=True, default='https://bit.ly/3YwXaHM', null=True, upload_to='avatars/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('method', models.CharField(choices=[('card', 'Card'), ('mobile_money', 'Mobile Money'), ('crypto', 'Cryptocurrency')], max_length=20)),
